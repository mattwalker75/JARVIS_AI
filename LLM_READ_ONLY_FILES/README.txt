...
JARVIS sees this folder mounted at /LLM_READ_ONLY_FILES. It can list and read files
...
produces for you — use the read-write folder next door: LLM_READ_WRITE_FILES/
(mounted at /LLM_READ_WRITE_FILES).
